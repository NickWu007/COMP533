...
public class HashtableSerializerTest {
	...
	public void testByteBuffer() {
		...
		try {
			...
			if (deserializedObject instanceof Hashtable) {
				Hashtable deserializedList = (Hashtable)deserializedObject;
				...
				fail("deserializedObject is not a Hashtable.");
			}
		} catch (Exception e) {
			e.printStackTrace();
